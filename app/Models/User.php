...
class User extends Authenticatable
{
    ...
    {
        return $this->hasMany(CreditApplication::class, 'user_id', 'id')->latest();
    }

    public function certificates(): HasMany
    {
        return $this->hasMany(CertificateOrder::class, 'user_id', 'id')->latest();
    }

    public function cards(): HasMany
    {
        return $this->hasMany(CardOrder::class, 'user_id', 'id')->latest();
    }
