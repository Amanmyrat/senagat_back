...
class UserPolicy
{
    ...
    {
        return $admin->can('delete_any_users');
    }
    ...
    {
        return $admin->can('force_delete_users');
    }
    ...
    {
        return $admin->can('force_delete_any_users');
    }
    ...
    {
        return $admin->can('restore_users');
    }
    ...
    {
        return $admin->can('restore_any_users');
    }
    ...
    {
        return $admin->can('replicate_users');
    }
    ...
    {
        return $admin->can('reorder_users');
    }
}
