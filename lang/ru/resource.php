...
return [
    ...
    'card_type' => 'Карты',
    'status' => 'Статус',
    'card_order_status' => 'Статус заявки на карту',
    'card_information' => 'Информация о карте',
    'branch_name' => 'Название филиала',
    'home_phone_number' => 'Домашний телефонный номер',
    'price' => 'Цена',
    'certificate_order_status' => 'Статус заявки на справку',
    'certificate_information' => 'Информация о справке',
    ...
    'card_orders' => 'Заявки на карты',
    'loan_applications' => 'Заявки на кредит',
    'certificate_orders' => 'Заявки на справки',
    'total_inquiries' => 'Всего запросов',
    'orders_overview_last_7_days' => 'Обзор заявок (за последние 7 дней)',
    'orders_distribution_by_status' => 'Распределение заявок по статусу',
    'recent_card_orders' => 'Последние заявки на карты',
    ...
    'international_payment_order' => 'Заявка на международный платеж',
